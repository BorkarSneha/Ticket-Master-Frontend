...
export const startAddDepartment=(formData,props)=>{
    return(dispatch)=>{
        axios.post('http://localhost:3025/departments',formData ,{
            headers: {'x-auth':localStorage.getItem('authToken')}
        })
        .then((response)=>{
...
export const startRemoveDepartment=(id)=>{
       return(dispatch)=>{
        axios.delete(`http://localhost:3025/departments/${id}`,{
            headers: {'x-auth':localStorage.getItem('authToken')}
        })
        .then((response)=>{
...
// export const startHandleSubmit=(formData)=>{
//     axios.post('http://localhost:3025/departments', formData, {
//         headers : {
...
//         {
//             const departments = prevState.departments.concat(department)
//             return ({departments})
//         })
//        }
